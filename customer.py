...
class Customer:
    ...
    def make_call(self, call: Call) -> None:
        ...
        for each_phone_line in self._phone_lines:
            if each_phone_line.number == call.src_number:
                each_phone_line.make_call(call)
        # pass
    ...
    def receive_call(self, call: Call) -> None:
        ...
        for customer_phone_line in self._phone_lines:
            if customer_phone_line.number == call.src_number:
                customer_phone_line.receive_call(call)
    ...
    def __str__(self) -> str:
        ...
        for line in self._phone_lines:
            s += str(line) + ' '
        return "id: " + str(self._id) + ' lines: ' + s
